...
$sql_teachers   =   "select * from tbl_teacher where school_id='".$_SESSION['school_id']."'";
$run_teacher    =   mysqli_query($db, $sql_teachers);
$count_teacher  =   mysqli_num_rows($run_teacher);

$sql_students   =   "select * from tbl_student where school_id='".$_SESSION['school_id']."'";
$run_student    =   mysqli_query($db, $sql_students);
$count_student  =   mysqli_num_rows($run_student);

$sql_posts   =   "select * from tbl_post where school_id='".$_SESSION['school_id']."'";
$run_post    =   mysqli_query($db, $sql_posts);
$count_post  =   mysqli_num_rows($run_post);
