                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr class="row_<?php echo $row['id']; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="javascript:void(0);" class="status_<?php echo $row['id']; ?>"><span class="badge bg-success" onclick="change_status(<?php echo $row['id']; ?>, 'requested', 'modules/posts/request.php')">Active</span></a>
                                                            <?php } else { ?>
                                                            <a href="javascript:void(0);" class="status_<?php echo $row['id']; ?>"><span class="badge bg-danger" onclick="change_status(<?php echo $row['id']; ?>, 'active', 'modules/posts/request.php')">Requested</span></a>
                                                            <?php } ?>		
                                                        </td>
                                                        <td >
