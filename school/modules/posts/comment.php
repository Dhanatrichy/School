...
if (isset($_POST['action']) && $_POST['action'] == 'post_comment') {
    ...
    $insert = "insert into tbl_post_comment(post_id,user_type,user_id,comment,datetime,addedon)values('" . $post_id . "','" . $_SESSION['user_type'] . "','" . $_SESSION['school_id'] . "','" . $comment_box . "','" . date("Y-m-d H:i:s", $time) . "','" . $time . "')";
